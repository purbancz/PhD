...
Rojek\index[names]{Rojek, Paweł} argumentuje, że powyższy fragment zawiera dwie podstawowe tezy teologii apofatycznej w ujęciu
Areopagity\index[names]{Pseudo-Dionizy Areopagita}. Według pierwszej z nich, o Bogu można w~sposób uprawniony
...
Rojka\index[names]{Rojek, Paweł} lub do jego trywializacji.



Problem ten dziedziczony jest przez tezę \eqref{rojek-T2}. Co więcej,
w~zamieszczonych powyższej cytatach z pism Dionizego\index[names]{Pseudo-Dionizy Areopagita}  wśród
instancji tej tezy
...
Teorię Niewysławianego Rojek\index[names]{Rojek, Paweł} charakteryzuje zgodnie z duchem prezentowanej w~niniejszej części pracy teologii milczenia. Poprawnie identyfikuje jej paradoksalny charakter mający swe źródła w~samozwrotności.
...
potrzeby takich przypadków Zinowjew\index[names]{Zinowjew, Aleksander} wprowadza nowy funktor nieokreśloności i
...
pojawiające się tezach teologii negatywnej Pseudo-Dionizego\index[names]{Pseudo-Dionizy Areopagita} pełnią
...
Przedstawione powyżej wywody dają Rojkowi\index[names]{Rojek, Paweł} asumpt, by dojść do wniosku, że zarówno w języku
...
Rojek\index[names]{Rojek, Paweł} zwraca uwagę, że zaproponowana prze niego interpretacja teologii
...
swoim zasięgiem wszystkich tez Dionizego\index[names]{Pseudo-Dionizy Areopagita}, nie mogą służyć za dobre
...
ponieważ ramy formalne, w jakie Rojek\index[names]{Rojek, Paweł} wsadził tę teorię, sprawiają, że do rozpatrzenia jest
...
W końcu, ciężko powiedzieć cokolwiek dobrego o~Rojka\index[names]{Rojek, Paweł} próbie podania formalnych ram
