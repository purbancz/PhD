...
różnica między teologią pozytywną i negatywną polega właśnie na orzekaniu o~Bogu pozytywnych własności lub ich negacji. Warunek negowania (lub orzekania) o nim takich własności Rojek umieścił w~następnikach (lub prawych członach równoważności) wszystkich zrekontrowanych w obrębie każdej z~interpretacji zdań o Bogu.
